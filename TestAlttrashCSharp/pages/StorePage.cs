...
namespace alttrashcat_tests_csharp.pages
{
    public class StorePage : BasePage
    {
        ...
        public AltObject TrashCatStatusButton { get => Driver.WaitForObject(By.PATH, "/Canvas/Background/CharacterList/Container/ItemEntry(Clone)/NamePriceButtonZone/PriceButtonZone/BuyButton/Text", timeout: 5); }
        ...
        {
            CharactersTabBtn.Tap();
        }
        public bool assertOwningTrashCatCharacter()
        {
            if(TrashCatStatusButton.GetText()=="Owned")
                return true;
            return false;
        }
